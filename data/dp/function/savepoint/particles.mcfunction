...
execute if entity @a[distance=..4, scores={saveLoad=10}] run particle cloud ~ ~ ~ 1 1 1 0 100 normal
...
execute at @a[distance=..4, scores={saveLoad=40}] if entity @a[distance=..4, scores={saveLoad=40}] run playsound minecraft:entity.player.levelup player @a[distance=..4] ~ ~ ~ 0.1 1
